...
* **Integer Overflow:** The calculator uses standard 32-bit `int` types for numerators and denominators. Extremely large products or denominators may result in integer overflow.
